/*
package com.johnlewis.partnerships
*/
/*
...
class DataBindingIdlingResourceFragment<F : Fragment> : IdlingResource {
    ...
    */
/**
     * Sets the fragment from a [FragmentScenario] to be used from [DataBindingIdlingResourceFragment].
     *//*
